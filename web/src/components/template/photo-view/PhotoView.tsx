...
export function PhotoView({ photo }: PhotoViewProps) {
  return (
    <>
      ...
      <div className="mfp-wrap mfp-gallery mfp-auto-cursor mfp-with-zoom mfp-img-mobile mfp-ready" tabIndex={1} style={{ overflow: 'hidden auto' }}>
        <div className="mfp-container mfp-image-holder mfp-s-ready">
          <div className="mfp-content">
            <div className="mfp-figure" style={{ visibility: 'visible' }}>
              ...
              <figure>
                <img className="mfp-img" src="https://story.habbix.ws/photos/d05c3b5f-d442-49ff-89df-5e7fa7ac5937.png" style={{ maxHeight: 1329 }}/>
