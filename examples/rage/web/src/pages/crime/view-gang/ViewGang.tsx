            ...
            <div className="members-container">
              {
                state.gang?.users?.length === 0 && (
                  <p>There are no users in this gang yet.</p>
                )
              }
              {
          ...
          <Card>
            ...
            <div className="row">
              ...
              <div className="col-8 text-right">
                ...
                <Button color="success" style={{ fontSize: 12 }} onClick={() => redirect(`profile/${state.gang?.owner?.username}`)}>View Profile</Button>
              </div>
            </div>
          </Card>
          <Card>
            ...
            <div className="row">
              <div className="col-4">
                <h5>Members</h5>
                {
                  state.gang?.users !== undefined
                    ? state.gang.users.length
