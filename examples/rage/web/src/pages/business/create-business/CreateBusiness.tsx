    ...
    <UserLayout section="corporations">
      ...
      <Container>
          ...
          <Form className="">
            ...
            <Card header="Strategy">
              ...
              <div className="text-right">
                <Button color="success" style={{ fontSize: 12 }}>Submit Application</Button>
              </div>
            </Card>
          </Form>
        </Column>
        <Column side="right">
          <Card>
            <h4>Useful Tips</h4>
            <p>Your business must be unique and have a fully developed idea on how you will implement it.  Be sure to go into as much detail as you can on the main concept.</p>
          </Card>
        </Column>
      </Container>
    </UserLayout>
