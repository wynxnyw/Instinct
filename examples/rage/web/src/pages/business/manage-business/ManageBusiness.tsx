                ...
                <div className="row">
                  <div className="col-lg-1">
                    <div style={{ marginTop: 10 }}>
                      <img alt="company badge" src={`${configContext.siteLink}/swfs/assets/c_images/corp-badges/${state.business?.badge}.gif`}/>
                    </div>
                  </div>
                  <div className="col text-right">
                    <h4>{state.business?.name}</h4>
                    <p style={{ float: 'right', whiteSpace: 'nowrap', width: 180, overflow: 'hidden', textOverflow: 'ellipsis' }}>{state.business?.desc}</p>
                  </div>
                </div>
              </div>
            </Card>
