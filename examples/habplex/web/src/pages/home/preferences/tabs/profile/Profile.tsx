...
import { defaultProfilePreferencesState, ProfilePreferencesState } from './Profile.types';
import { Form, Icon, Input, Row, sessionContext, sessionService } from 'instinct-frontend';
      ...
      <div>
        ...
        <Row>
          <div className="column-2">
            <Input type="text" name="favoriteYoutubeVideo" value={state.favoriteYoutubeVideo} onChange={updateField}/>
          </div>
        </Row>
      </div>
