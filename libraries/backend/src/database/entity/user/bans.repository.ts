...
export class UserBanRepository {
  constructor(@InjectRepository(UserBanEntity) private readonly userBanRepo: Repository<UserBanEntity>) {}

  private readonly eagerRelations: Array<keyof UserBanEntity> = ['user', 'staffMember'];
  ...
  async updateByID(banID: number, changes: Partial<UserBanEntity>): Promise<void> {
