...
export class UserForgotPasswordRepository {
  constructor(@InjectRepository(UserForgotPasswordEntity) private readonly userForgotPasswordRepo: Repository<UserForgotPasswordEntity>) {}

  create(userID: number, token: string, expiresAt: number): Promise<UserForgotPasswordEntity> {
