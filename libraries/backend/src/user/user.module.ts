...
@Module({
  ...
  providers: [UserPipe, UserService, UserLeaderBoardService, UserBanPipe, ...userConstraints],
  exports: [UserPipe, UserService, UserLeaderBoardService, UserBanPipe, ...userConstraints],
})
