...
import { EmailPreferencesState, defaultEmailPreferencesState } from './Email.types';
  ...
  if (state.showCompletion) {
    return (
      <div className="text-center">
        ...
        <p>Your email has been changed to <b>{state.email}</b>!</p>
      </div>
    )
  }
      ...
      <div>
        ...
        <Row>
          <div className="column-2">
            <Input type="password" name="password" placeholder="Enter your current password" value={state.password} onChange={updateField}/>
          </div>
        </Row>
      </div>
      <div className="mt-5">
        ...
        <Row>
          <div className="column-2">
            <Input type="text" name="email" placeholder="Enter your new email" value={state.email} onChange={updateField}/>
          </div>
        </Row>
      </div>
