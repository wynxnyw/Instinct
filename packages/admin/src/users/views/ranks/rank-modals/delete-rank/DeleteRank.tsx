...
export function DeleteRankModal({ children, rankID, rankName, onDeletion }: DeleteRankModalProps) {
    ...
    <>
      ...
      <Modal isOpen={isOpen} toggle={toggle}>
        ...
        <ModalBody className="text-center">
          ...
          <h4>You're about to delete <b>{rankName}</b></h4>
          <p>This action is irreversible and your changes cannot be undone.</p>
        </ModalBody>
        <ModalFooter>
          <div className="row">
            <div className="col-6">
              <button className="btn btn-danger" disabled={spinner} onClick={deleteRank}>
                {
                  spinner
